...
```
我们可以看到，XLogLongPageHeaderData仅仅比XLogPageHeaderData多了三个成员变量，共计16个字节，其目的是为了校验WAL文件的。从上面可以推知，XLogPageHeaderData有20个字节，而XLogLongPageHeaderData是36个字节。下面我们用hexdump来查看一个WAL文件的头部：
```
$ pwd
