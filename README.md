...
在IT行业浪迹了二十多年以后，我决定写人生第一本关于IT技术的书，那就是本书。也许是因为命运的安排，十多年前我来到美国后，阴差阳错地进入了数据库管理员DBA（Database Administrator）的行业，自己职业生涯的大部分时间是和Oracle等数据库打交道，所以本书是关于著名的开源数据库PostgreSQL的书，是类似“某某某从入门到精通”之类的内容，但绝对不会教你从删库到跑路。
